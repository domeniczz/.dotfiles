...
c.aliases = {
    ...
    'translate-selection': 'spawn --userscript translate-selection',
    'search-archive': 'spawn --userscript search-archive',
    'incognito': 'open -p',
...
c.editor.command = ['footclient', '-T', 'float_window', '-e', 'nvim', '{file}', "+call cursor({line}, {column})"]
...
config.bind('<Ctrl-Shift-W>', 'undo --window')
...
config.bind('gp', 'open -t -- {clipboard}')
...
config.bind('<Ctrl-O>', 'cmd-set-text -s :open', mode='caret')
config.bind('<Ctrl-Shift-O>', 'cmd-set-text -s :open -t', mode='caret')
...
config.bind('<Ctrl-N>', 'open -w')
config.bind('<Ctrl-Shift-N>', 'open -p', mode='insert')
config.bind('<Ctrl-Shift-P>', 'open -p', mode='insert')
config.bind('<Ctrl-Shift-T>', 'undo', mode='insert')
...
config.bind('<Ctrl-O>', 'cmd-set-text -s :open', mode='insert')
config.bind('<Ctrl-Shift-O>', 'cmd-set-text -s :open -t', mode='insert')
...
config.bind('<Ctrl-N>', 'open -w')
config.bind('<Ctrl-Shift-N>', 'open -p', mode='passthrough')
config.bind('<Ctrl-Shift-P>', 'open -p', mode='passthrough')
config.bind('<Ctrl-Shift-T>', 'undo', mode='passthrough')
...
config.bind('<Ctrl-O>', 'cmd-set-text -s :open', mode='passthrough')
config.bind('<Ctrl-Shift-O>', 'cmd-set-text -s :open -t', mode='passthrough')
...
config.bind('<Alt-A>', 'spawn --userscript search-archive')
config.bind('<Alt-A>', 'spawn --userscript search-archive', mode='insert')
config.bind('<Alt-A>', 'spawn --userscript search-archive', mode='passthrough')
config.bind('<Alt-A>', 'spawn --userscript search-archive', mode='caret')
...
c.colors.tabs.pinned.odd.bg = 'darkseagreen'
...
c.colors.completion.category.bg = '#3c3c3c'
c.colors.completion.category.fg = 'white'
c.colors.completion.category.border.bottom = '#222222'
c.colors.completion.category.border.top = '#3c3c3c'
c.colors.completion.even.bg = '#222222'
c.colors.completion.odd.bg = '#2d2d2d'
c.colors.completion.fg = ['white', 'white', 'white']
c.colors.completion.match.fg = '#ff3030'
c.colors.completion.item.selected.bg = '#f0a000'
c.colors.completion.item.selected.fg = 'black'
c.colors.completion.item.selected.border.bottom = '#f0a000'
c.colors.completion.item.selected.border.top = '#222222'
c.colors.completion.item.selected.fg = 'black'
c.colors.completion.item.selected.match.fg = 'red'
c.colors.completion.scrollbar.bg = '#3c3c3c'
c.colors.completion.scrollbar.fg = '#666666'
...
default_ua_format = 'Mozilla/5.0 ({os_info}) AppleWebKit/{webkit_version} (KHTML, like Gecko) {upstream_browser_key}/{upstream_browser_version_short} Safari/{webkit_version}'
config.set('content.headers.user_agent', default_ua_format, '*://challenges.cloudflare.com/*')
